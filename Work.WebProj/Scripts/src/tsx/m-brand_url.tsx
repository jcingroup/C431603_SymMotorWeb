...
namespace BrandUrl {
    ...
    class GridRow extends React.Component<BaseDefine.GridRowPropsBase<Rows>, BaseDefine.GridRowStateBase> {
        ...
        static defaultProps = {
            fdName: 'fieldData',
            gdName: 'searchData',
            apiPathName: gb_approot + 'api/BrandUrl'
        }
        delCheck(i, chd) {
        ...
        render() {
            ...
            return <tr>
                ...
                <td>{this.props.itemData.brand_url_title}</td>
                <td>{this.props.itemData.url}</td>
    ...
    export class GridForm extends React.Component<BaseDefine.GridFormPropsBase, FormState<Rows, server.BrandUrl>>{
        ...
        static defaultProps: BaseDefine.GridFormPropsBase = {
            fdName: 'fieldData',
            gdName: 'searchData',
            apiPath: gb_approot + 'api/BrandUrl'
        }
        componentDidMount() {
        ...
        deleteSubmit() {
            ...
            for (var i in this.state.gridData.rows) {
                if (this.state.gridData.rows[i].check_del) {
                    ids.push('ids=' + this.state.gridData.rows[i].brand_url_id);
                }
            }
        ...
        delCheck(i: number, chd: boolean) {
            let BrandUrltate = this.state;
            this.state.gridData.rows[i].check_del = !chd;
            this.setState(BrandUrltate);
        }
        checkAll() {

            let BrandUrltate = this.state;
            BrandUrltate.checkAll = !BrandUrltate.checkAll;
            for (var prop in this.state.gridData.rows) {
                this.state.gridData.rows[prop].check_del = BrandUrltate.checkAll;
            }
            this.setState(BrandUrltate);
        }
        insertType() {
                            ...
                            <div className="col-xs-10">
                                <div className="form-group">
                                    ...
                                    <div className="col-xs-8">
                                        <input type="text" className="form-control" onChange={this.changeFDValue.bind(this, 'brand_url_title')} value={fieldData.brand_url_title} maxLength={64} required />
                                    </div>
                                    <small className="col-xs-2 help-inline"><span className="text-danger">(必填) </span>, 最多64字</small>
                                </div>
                                <div className="form-group">
                                    <label className="col-xs-2 control-label">超連結</label>
                                    <div className="col-xs-8">
                                        <input type="url" className="form-control" onChange={this.changeFDValue.bind(this, 'url')} value={fieldData.url} maxLength={1024} required />
                                    </div>
                                    <small className="col-xs-2 help-inline"><span className="text-danger">(必填) </span>, 最多1024字</small>
                                </div>
                                <div className="form-group">
...
ReactDOM.render(<BrandUrl.GridForm caption={gb_caption} menuName={gb_menuname} iconClass="fa-list-alt" />, dom);