...
namespace Editor {
    ...
    class GridRow extends React.Component<BaseDefine.GridRowPropsBase<Rows>, BaseDefine.GridRowStateBase> {
        ...
        static defaultProps = {
            fdName: 'fieldData',
            gdName: 'searchData',
            apiPathName: gb_approot + 'api/Editor'
        }
        delCheck(i, chd) {
    ...
    export class GridDetailForm extends React.Component<DetailFormProps, DetailFormState>{
        ...
        componentWillReceiveProps(nextProps: DetailFormProps) {
            this.queryGridData(nextProps.MainId);//語系有改變就重新讀取gridData
        }
        ...
        creatNewData() {
            let newState = this.state;
            let newData: server.EditorDetail = {
                editor_detail_id: 0,
                editor_id: this.props.MainId,
                detail_content: null,
                sort: 0,
                i_Hide: false,
        ...
        deleteItem(i: number) {
            ...
            if (data.edit_state == EditState.Insert) {
                ...
                CommFunc.jqDelete(this.props.apiDetailPath + '?ids=' + data.editor_detail_id, {})
                    .done(function (data, textStatus, jqXHRdata) {
                        if (data.result) {
                            newState.gridData.splice(i, 1);
                            this.setState(newState);
                        ...
                        <div className="panel-body">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-xs-3">
                                    <input className="form-control" type="text" value={fieldData.detail_name} onChange={this.changeFDValue.bind(this, 'detail_name') } maxLength={64} required/>
                                    </div>
...
ReactDOM.render(<Editor.GridForm caption={gb_caption} menuName={gb_menuname} iconClass="fa-list-alt" />, dom);